...
if is_save:
    data_dic = { "t_arr": t_mat, "q_arr": q_mat, "p_arr": p_mat, "R_arr": R_mat, "R0_arr": R0_mat, "obs1": obs1, "obs2": obs2,"obs3": obs3,
                "dp_arr": dp_mat, "p0_arr": p0_mat, "dq_arr": dq_mat, "dp0_arr": dp0_mat, "Kp": Kp, "Bp": Bp, "m": m,
                 "Keps": Keps, "Beps": Beps, "Bq": Bq, "k_obs": k_obs, "p_links": p_links_save, "R_links": R_links_save, "gain_mat":gain_mat }
    savemat( "./ThesisExamples/data/sec531_energy_budget_obs_avoid.mat", data_dic )
