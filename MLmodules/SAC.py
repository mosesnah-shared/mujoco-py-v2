...
class Policy( nn.Module ):
	...
	def forward( self, x, get_logprob = False ):
		# Policy maps from n_state to 2*n_action parameters
...
if __name__ == "__main__":
	...
	agent = SAC_Agent( seed, n_state, n_action )
	...
	while samples_number < total_steps:
		...
		while not real_done:
			...
			real_done = True if time_step == max_steps else done
