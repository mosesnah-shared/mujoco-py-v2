...
q1 = 0.2
q_init = np.array( [ q1, np.pi - 2*q1+0.2 ] )
...
if is_save:
    ...
    if is_obs:
        scipy.io.savemat( "task_imp_sub_obs.mat", my_dict )
    else:
